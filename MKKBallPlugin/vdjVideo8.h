...
public:
	...
	// call GetVertices() to retrieve the default vertices, and modify it. (or pass NULL to DrawDeck() to use the default)
	...
	// For OpenGL, GetDevice() returns NULL, for DirectX 9, it needs to point to a IDirect3DDevice9*
